...
object FoodsData {
    ...
    private const val baseFoodPhotos = "https://www.themealdb.com/images/category/"

    private val foodPhotoss = arrayOf(
        "beef.png",
        "chicken.png",
        "dessert.png",
        "lamb.png",
    ...
    val listData: ArrayList<Food>
        get() {
            ...
            for (i in foodNames.indices) {
                ...
                food.detail = foodDetails[i]
                food.photo = baseFoodPhotos + foodPhotoss[i]
                list.add(food)
            }
            return list
        }
